...
export const en = {
  ...
  aboutMenu: 'About Local Harness',
  aboutProduct: 'Local Harness',
  aboutVersion: 'Version V{version}',
  hideApplication: 'Hide Local Harness',
  hideOtherApplications: 'Hide Others',
  showAllApplications: 'Show All',
  quitApplication: 'Quit Local Harness',
  edit: 'Edit',
  ...
  startupFailed: 'Local Harness is unavailable',
  ...
  welcomeTitle: 'Local Harness',
  welcomeBrand: 'Local Harness',
  welcomeTaglineBefore: 'Welcome to ',
  welcomeTaglineBrand: 'Local Harness',
  welcomeTaglineAfter: '',
  ...
  welcomeLocal: 'Use local models',
  welcomeSignIn: 'Sign in to DeepSeek',
  ...
  updateDownloadedTitle: 'Local Harness v{version} downloaded',
  ...
  updateTitle: 'Local Harness Update',
  updateAvailable: 'An update is available',
  updateDetail: 'Local Harness {version}\n\nLocal Harness will restart to complete the update.',
...
export const zh = {
  application: '应用',
  aboutMenu: '关于 Local Harness',
  aboutProduct: 'Local Harness',
  aboutVersion: '版本 V{version}',
  hideApplication: '隐藏 Local Harness',
  hideOtherApplications: '隐藏其他',
  showAllApplications: '显示全部',
  quitApplication: '退出 Local Harness',
  edit: '编辑',
  menuBar: '应用菜单',
  delete: '删除',
  undo: '撤销',
  ...
  paste: '粘贴',
  selectAll: '全选',
  startupFailed: 'Local Harness 无法使用',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'Local Harness v{version} 下载完成',
  ...
  updateTitle: 'Local Harness 更新',
  updateAvailable: '发现可用更新',
  updateDetail: 'Local Harness {version}\n\nLocal Harness 将重启以完成更新。',
