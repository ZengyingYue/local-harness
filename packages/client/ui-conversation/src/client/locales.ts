...
export const zh = {
  ...
  'hero.headline': '向未知，发出信号',
  'hero.eyebrow': 'LOCAL HARNESS / ORBITAL STATION',
  'hero.subtitle': '你的模型，你的轨道。连接 API 或本地智能，从这里探索无限。',
  'hero.preview': '预览版',
...
export const en = {
  ...
  'hero.headline': 'Make contact. Go beyond.',
  'hero.eyebrow': 'LOCAL HARNESS / ORBITAL STATION',
  'hero.subtitle': 'Your models. Your orbit. Connect an API or local intelligence and explore.',
