...
export const zh = {
  ...
  'hero.headline': '让想法，即刻启航',
  'hero.eyebrow': 'LOCAL HARNESS · 任务控制中心',
  'hero.subtitle': '连接本地智能，探索更远的可能。',
  'hero.preview': '预览版',
...
export const en = {
  ...
  'hero.headline': 'Ready for your next mission',
  'hero.eyebrow': 'LOCAL HARNESS · MISSION CONTROL',
  'hero.subtitle': 'Local intelligence. Room to explore.',
