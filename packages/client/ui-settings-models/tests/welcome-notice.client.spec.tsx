...
describe('WelcomeNotice', () => {
  it('uses the exact owner copy in both GUI locales', () => {
    expect(WELCOME_NOTICE_COPY.en).toEqual({
      title: 'Welcome to Local Harness',
      body: 'Connect a model API or a local Ollama / LM Studio service in Settings → Models. No account is required. Your conversations, tools, and workspaces are managed from this application.',
