...
export const zh = {
  ...
  closeDetails: '关闭字体详情',
  unavailable: 'Office 预览不可用。请在运行 Local Harness 的主机上启用文档预览服务。',
...
export const en = {
  ...
  unavailable: 'Office previews are unavailable. Enable the document preview service on the computer running Local Harness.',
