...
The shared desktop and Web frame uses theme-owned aerospace background tokens while retaining platform titlebar clearances, resizable columns, and all registered feature slots.
