...
export const zh = {
  ...
  installGuideSafety: '请确认插件来源可信。插件在本机以你的权限运行，来源不明的插件可能损坏 Local Harness，或读取和泄露你的数据。',
  registryToggle: '安装源',
...
export const en = {
  ...
  installGuideSafety: 'Install only plugins you trust: they run with your permissions and can damage Local Harness or leak your data.',
